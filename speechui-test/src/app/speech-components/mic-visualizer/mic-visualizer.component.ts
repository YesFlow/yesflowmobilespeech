...
@Component({
  selector: 'app-mic-visualizer',
  templateUrl: './mic-visualizer.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./mic-visualizer.component.scss'],
})
export class MicVisualizerComponent implements OnInit, OnDestroy {
  ...
  constructor() {
    ...
    // this.AudioContext =  new AudioContext() || false;
